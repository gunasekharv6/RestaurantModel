...
public class DeliveryManWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public DeliveryManWorkAreaJPanel(JPanel userProcessContainer, EcoSystem ecoSystem, AreaNetwork areaNetwork, UserAccount userAccount) {
...
//        
    ...
    private void populateData() {
        ...
        DeliveryMan deliveryMan = (DeliveryMan) userAccount.getParentClass();
        for(Order order:deliveryMan.getOrders()){
            if(order.getOrderStatus().name().equalsIgnoreCase(OrderStatus.Delivered.name())){
                ...
                row[5] = order.getAcceptedBy().getUseraccount().getName();
    ...
    private void initComponents() {
        ...
        currentOrdersHeaderjLabel.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        currentOrdersHeaderjLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        currentOrdersHeaderjLabel.setText("Orders To Be Delivered");
        ...
        currentOrdersjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S.No", "CustomerName", "Customer Notes", "Total Price", "Status", "AcceptedBy", "Restaurant"
            }
        ) {
        ...
        currentOrdersHeaderjLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        currentOrdersHeaderjLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        currentOrdersHeaderjLabel1.setText("Orders Successfully Delivered");
        ...
        deliveredOrdersjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S.No", "Customer Name", "Customer Notes", "Total Price", "Status", "AcceptedBy", "Restaurant"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
        ...
        deliveredjButton.setText("Delivered already? Click here to notify");
