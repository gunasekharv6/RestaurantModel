 ...
 * @author gunav
 */
public class CreateItemJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CreateItemJPanel
     */
    ...
    public CreateItemJPanel(JPanel userProcessContainer, UserAccount userAccount, Restaurant restaurant) {
    ...
    private void savejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savejButtonActionPerformed
        ...
        if(isDataEnteredValid()) {
            restaurant.getItems().add(new Item(menuNamejTextField.getText(), Double.valueOf(pricejTextField.getText())));
            JOptionPane.showMessageDialog(this, "Item Saved Successfully");
            menuNamejTextField.setText("");
            pricejTextField.setText("");
        }else {
            JOptionPane.showMessageDialog(this, "Error. Please check the entered values and TRY AGAIN");
        }
