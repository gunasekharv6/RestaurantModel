...
//mport Business.WorkQueue.LabTestWorkRequest;
...
public class ManageOrdersJPanel extends javax.swing.JPanel {
   ...
   private Restaurant restaurant;
     ...
     */
    public ManageOrdersJPanel(JPanel userProcessContainer, EcoSystem business, UserAccount account, Restaurant restaurant) {
        initComponents();
        ...
        System.out.println("Inside ManageOrdersJPanel "+restaurant.getName());
        System.out.println("Inside ManageOrdersJPanel "+restaurant.getOrderList().size());
        populateTable();
    }
...
//        if (restaurant.getOrderList().size()!=0){
            for(Order order:restaurant.getOrderList()) {
                ...
                row[2] = order.getCustomerNotes();
                row[3] = order.getStatus();
                row[4] = order.getFeedback();
                dtm.addRow(row);
            }
//        }
    }
    ...
    private void initComponents() {
        ...
        orderRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order Id", "Customer Name", "Message from customer", "Status", "Feedback"
            }
        ) {
    ...
    private void BtnDeliverOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDeliverOrderActionPerformed
        ...
        Order order1 = (Order)orderRequestJTable.getValueAt(selectedRow, 0);
         ...
         return ; }
        AssignDeliveryManJPanel panel = new AssignDeliveryManJPanel(userProcessContainer,order1,restaurant, system);
    ...
    private void viewItemsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewItemsBtnActionPerformed
        ...
        dtm.setRowCount(0);
        for(Item i:order1.getItemsList()) {
