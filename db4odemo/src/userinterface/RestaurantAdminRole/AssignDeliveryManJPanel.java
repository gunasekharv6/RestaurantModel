...
public class AssignDeliveryManJPanel extends javax.swing.JPanel {
     ...
     */
    public AssignDeliveryManJPanel(JPanel userProcessContainer, Order order, Restaurant rt, EcoSystem business) {
        initComponents();
   ...
   public void  populateComboBox(){
       //System.out.println("Inside populateComboBox of -- AssignDeliveryManJPanel"); 
       DefaultComboBoxModel dm=new DefaultComboBoxModel();
           //for(Restaurant r : system.getRestaurantDirectory().getRestaurantList()){
             for(DeliveryMan delvryman : restaurant.getDeliveryManDirectory().getDeliveryManList()){//system.getDeliveryManDirectory().getDeliveryManList()) {
//                 System.out.println(delvryman);
//                if(delvryman.)
                 dm.addElement(delvryman); 
             }
  // }
    ...
    private void requestdeliveryJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestdeliveryJButtonActionPerformed
        DeliveryMan delvman = (DeliveryMan) deliveryManComboBox.getSelectedItem();
        UserAccount selectedUser = delvman.getUseraccount();
        if (delvman == null){
            return;
        }
        order.setStatus("assigned");
        order.setDeliveryMan(delvman);  
        order.setDeliveryManUseraccount(selectedUser); 
        order.setDeliveryManId(delvman.getId()); 
